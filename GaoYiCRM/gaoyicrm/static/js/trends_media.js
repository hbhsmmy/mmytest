...
function replaceContent(item){
    $(".news-lists").append('<li class="border-b"><a href="../trends_media_info/'+item.id+'" class="clearfix"><p class="pull-left textEllipsis cl-555">'+item.title+'</p><em class="cl-999 pull-right glyphicon glyphicon-menu-right"></em><span class="pull-right cl-666 hidden-xs">'+item.time+'</span></a></li>');
}
